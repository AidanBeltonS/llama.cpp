...
// Same as vec_dot_q4_K_q8_1 but the q4_K block is already resident in shared
// memory (LDS) and passed directly as a typed pointer (no vbq/kbx indirection).
// Used by the RDNA4 cooperative-staging path in mmvq.cu.
