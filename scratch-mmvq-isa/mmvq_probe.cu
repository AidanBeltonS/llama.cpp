// AUTO-GENERATED by gen_probe.sh - do NOT edit by hand.
#include "common.cuh"
#include "vecdotq.cuh"
#include "unary.cuh"
#include <cstdint>
...
template __global__ void mul_mat_vec_q<(ggml_type)12, 1, true, false, false>(const void*, const void*, const int32_t*, const ggml_cuda_mm_fusion_args_device, float*, const uint32_t, const uint3, const uint32_t, const uint32_t, const uint32_t, const uint3, const uint32_t, const uint32_t, const uint32_t, const uint3, const uint32_t, const uint32_t, const uint32_t, const uint32_t);
template __global__ void mul_mat_vec_q<(ggml_type)12, 1, false, false, false>(const void*, const void*, const int32_t*, const ggml_cuda_mm_fusion_args_device, float*, const uint32_t, const uint3, const uint32_t, const uint32_t, const uint32_t, const uint3, const uint32_t, const uint32_t, const uint32_t, const uint3, const uint32_t, const uint32_t, const uint32_t, const uint32_t);
template __global__ void mul_mat_vec_q<(ggml_type)14, 1, true, false, false>(const void*, const void*, const int32_t*, const ggml_cuda_mm_fusion_args_device, float*, const uint32_t, const uint3, const uint32_t, const uint32_t, const uint32_t, const uint3, const uint32_t, const uint32_t, const uint32_t, const uint3, const uint32_t, const uint32_t, const uint32_t, const uint32_t);
template __global__ void mul_mat_vec_q<(ggml_type)14, 1, false, false, false>(const void*, const void*, const int32_t*, const ggml_cuda_mm_fusion_args_device, float*, const uint32_t, const uint3, const uint32_t, const uint32_t, const uint32_t, const uint3, const uint32_t, const uint32_t, const uint32_t, const uint3, const uint32_t, const uint32_t, const uint32_t, const uint32_t);
